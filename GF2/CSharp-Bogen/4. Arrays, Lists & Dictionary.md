...
// Før du slår en nøgle op, bør du tjekke om den findes – ellers får du KeyNotFoundException
if (ageMap.ContainsKey("Anders"))
{
    Console.WriteLine("Anders er " + ageMap["Anders"] + " år");
}
else
{
...
**Videoer (Bro Code)**  
![C# arrays](https://www.youtube.com/watch?v=IHMmPVEOT64)  
![C# multidimensional arrays](https://www.youtube.com/watch?v=G1kYoPr1Ru8)  
![C# Lists](https://www.youtube.com/watch?v=vQzREQUhGSA)  
![C# foreach loop](https://www.youtube.com/watch?v=WhACXlObR8s)  
![C# List of objects](https://www.youtube.com/watch?v=aLhAmimoQj8)

**C# for Beginners (Microsoft)**  
![List T and Collections of Data [Pt 12]](https://www.youtube.com/watch?v=M3UsM9l1m6c)  
[Arrays, Lists, Indexing, and Foreach [Pt 13]](https://learn.microsoft.com/en-us/shows/csharp-for-beginners/arrays-lists-indexing-and-foreach-csharp-for-beginners/) · [Sorting and Searching Lists [Pt 14]](https://learn.microsoft.com/en-us/shows/csharp-for-beginners/sorting-and-searching-lists-csharp-for-beginners/)  
