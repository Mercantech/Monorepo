...
Når du skal lave spil eller øvelser hvor et "hemmeligt" tal skal findes (fx gæt-et-tal), bruger du klassen `Random`.

```csharp
Random random = new Random();
int hemmeligtTal = random.Next(1, 11);  // Tal fra 1 til og med 10 (max er eksklusiv)
```

`Next(min, max)` returnerer et heltal fra `min` inklusiv til `max` **eksklusiv**. Så `Next(1, 11)` giver 1, 2, …, 10.
...
![C# for loops](https://www.youtube.com/watch?v=h4hY2hho73Q)  
![C# nested loops](https://www.youtube.com/watch?v=WFzLcZk137s)  
![C# foreach loop](https://www.youtube.com/watch?v=WhACXlObR8s)  
![C# random numbers](https://www.youtube.com/watch?v=1gSFd-YVFP8)  
![C# number guessing game](https://www.youtube.com/watch?v=wjioHdpZ6_s)
